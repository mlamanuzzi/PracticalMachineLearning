...
set.seed(20150322)
modRandomForest <- train(classe~.,method="rf",data=myTraining,trControl=trainControl(method='cv'),number=5,allowParallel=TRUE)
...
finalPredictions
```
The model correctly categorized all 20 testing samples.
